...
<head>
    <meta charset="utf-8"/>
    <link rel="icon" type="image/png" href="landing/assets/img/favicon.ico">
...
<div class="wrapper">
    <div class="parallax filter-gradient blue" data-color="blue">
        <div class="parallax-background">
            <img class="parallax-background-image" src="landing/assets/img/template/bg3.jpg">
        </div>
        <div class="container">
            <div class="row">
                <div class="col-md-5 hidden-xs">
                    <div class="description">
                        <h3 style="text-align: center">Calling Youth Advocates In Kenya</h3>
                        <p>
                        <ol>
                            <li>Are you a Kenyan youth working to change the world … or at least parts of it?</li>
                            <li>Are you a Kenyan youth trying to influence policies effecting you and your community?</li>
                            <li>Have you ever wondered who else is working on the same issues in your county?</li>
                            <li>Do you want to connect with other youth advocates across your county or across Kenya?</li>
                        </ol>
                        If you answered <b>“YES”</b> to any of these questions, then <a href="http://amref.org/"  target="_blank">Amref Health Africa</a> and
                        <a href="http://www.advocacyaccelerator.org/"  target="_blank">The Advocacy Accelerator</a> invites you to register with our new Youth Advocacy Portal.
                        </p>
                    </div>
                </div>
                <div class="col-md-6 col-md-offset-1">
                    <div class="description">
                        <br>
                        <p>Registering with the Portal will enable you to:
                            <ul>
                                <li>Receive advocacy information and tools that can help you do better advocacy</li>
                                <li>Find and connect with other youth advocates and youth advocacy
                                    organizations and networks (and even better, they can find and connect with you!)</li>
                                <li>Join youth advocacy efforts across the country</li>
                            </ul>
                            Completing the survey and joining this growing network of youth will take less than 10 minutes. We look forward to working with you!
                        </p>
                    </div>
                    <div class="buttons">
    ...
    <!--            <div class="section section-gray section-clients">
                    <div class="container text-center">
                        ...
                        <div class="logos">
                            <ul class="list-unstyled">
                                <li ><img src="x_awesome_landing_page/assets/img/logos/adobe.png"/></li>
                                <li ><img src="x_awesome_landing_page/assets/img/logos/zendesk.png"/></li>
                                <li ><img src="x_awesome_landing_page/assets/img/logos/ebay.png"/></i>
                                <li ><img src="x_awesome_landing_page/assets/img/logos/evernote.png"/></li>
                                <li ><img src="x_awesome_landing_page/assets/img/logos/airbnb.png"/></li>
                                <li ><img src="x_awesome_landing_page/assets/img/logos/zappos.png"/></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-5 col-md-offset-1 hidden-xs">
                                <img src="x_awesome_landing_page/assets/img/template/mac.png"/>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-md-6">
                                <div id="description-carousel" class="carousel fade" data-ride="carousel">
                                    <div class="carousel-inner">
                                        <div class="item">
                                            <img src="x_awesome_landing_page/assets/img/template/examples/home_33.jpg" alt="">
                                        </div>
                                        <div class="item active">
                                            <img src="x_awesome_landing_page/assets/img/template/examples/home_22.jpg" alt="">
                                        </div>
                                        <div class="item">
                                            <img src="x_awesome_landing_page/assets/img/template/examples/home_11.jpg" alt="">
                                        </div>
                                    </div>
                    ...
                    <div class="container">
                        ...
                        <div id="carousel-example-generic" class="carousel fade" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                <div class="item">
                                    <div class="mask">
                                        <img src="x_awesome_landing_page/assets/img/faces/face-4.jpg">
                                    </div>
                                ...
                                <div class="item active">
                                    <div class="mask">
                                        <img src="x_awesome_landing_page/assets/img/faces/face-3.jpg">
                                    </div>
                                    <div class="carousel-testimonial-caption">
                                        <p>Drake, Artist</p>
                                ...
                                <div class="item">
                                    <div class="mask">
                                        <img src="x_awesome_landing_page/assets/img/faces/face-2.jpg">
                                    </div>
                                    <div class="carousel-testimonial-caption">
                ...
                <div class="section section-no-padding">
                    <div class="parallax filter-gradient blue" data-color="blue">
                        <div class="parallax-background">
                            <img class ="parallax-background-image" src="x_awesome_landing_page/assets/img/template/bg3.jpg"/>
                        </div>
                        <div class="info">
